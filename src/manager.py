...
class Manager:
    """Manager for loading data and handling apartments, tenants,
    transfers, bills, and apartment events.

    Attributes:
        apartments: Loaded apartments by key.
        tenants: Loaded tenants by key.
        transfers: Loaded transfer records.
        bills: Loaded bill records.
        tenants_blacklist: Loaded blacklist entries.
        apartment_events: Loaded apartment events.

    """

    def __init__(self, parameters: Parameters):
        """Initialize manager with configuration parameters."""
